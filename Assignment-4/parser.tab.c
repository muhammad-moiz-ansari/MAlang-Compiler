...
static const char *const yytname[] =
{
  ...
  "LBRACKET", "RBRACKET", "COLON", "COMMA", "TRUE_VAL", "FALSE_VAL",
  "NULL_VAL", "STRING", "NUMBER", "$accept", "json", "value", "object",
  "members", "array", "elements", "key", YY_NULLPTR
};
...
{
      18,     2,    -1,    -6,    -6,    -6,    -6,    -6,     7,    -6,
      -6,    -6,    -6,    -6,     9,     8,    -6,    -6,    -5,    -6,
      -6,     4,    18,    -6,    18,    11,    -6,    -6,    18,    -6
};
...
{
       0,     0,     0,     7,     8,     9,     5,     6,     0,     2,
       3,     4,    10,    18,     0,     0,    14,    16,     0,     1,
      11,     0,     0,    15,     0,     0,    12,    17,     0,    13
};
...
static const yytype_int8 yytable[] =
{
      17,    23,     1,    24,     2,    16,    12,    19,     3,     4,
       5,     6,     7,    20,    13,    22,    13,    21,    28,     0,
      26,     1,    27,     2,    25,     0,    29,     3,     4,     5,
       6,     7
};
...
static const yytype_int8 yycheck[] =
{
      ...
      11,    12,    13,     4,    12,     7,    12,     8,     7,    -1,
      22,     3,    24,     5,    21,    -1,    28,     9,    10,    11,
      12,    13
};
...
static const yytype_int8 yystos[] =
{
      ...
      17,    19,     4,    12,    18,    21,     6,    16,    20,     0,
       4,     8,     7,     6,     8,    21,    16,    16,     7,    16
};
...
yyreduce:
  ...
  case 2: /* json: value  */
#line 43 "parser.y"
          { root = (yyvsp[0].node_val); }
#line 1096 "parser.tab.c"
    break;

  case 3: /* value: object  */
#line 47 "parser.y"
                    { (yyval.node_val) = (yyvsp[0].obj_val); }
#line 1102 "parser.tab.c"
    break;

  case 4: /* value: array  */
#line 48 "parser.y"
                    { (yyval.node_val) = (yyvsp[0].arr_val); }
#line 1108 "parser.tab.c"
    break;

  case 5: /* value: STRING  */
#line 49 "parser.y"
                    { (yyval.node_val) = new StringNode(std::string((yyvsp[0].str_val))); free((yyvsp[0].str_val)); }
#line 1114 "parser.tab.c"
    break;

  case 6: /* value: NUMBER  */
#line 50 "parser.y"
                    { (yyval.node_val) = new NumberNode((yyvsp[0].num_val)); }
#line 1120 "parser.tab.c"
    break;

  case 7: /* value: TRUE_VAL  */
#line 51 "parser.y"
                    { (yyval.node_val) = new BoolNode(true); }
#line 1126 "parser.tab.c"
    break;

  case 8: /* value: FALSE_VAL  */
#line 52 "parser.y"
                    { (yyval.node_val) = new BoolNode(false); }
#line 1132 "parser.tab.c"
    break;

  case 9: /* value: NULL_VAL  */
#line 53 "parser.y"
                    { (yyval.node_val) = new NullNode(); }
#line 1138 "parser.tab.c"
    break;

  case 10: /* object: LBRACE RBRACE  */
#line 57 "parser.y"
                    { (yyval.obj_val) = new ObjectNode(); }
...
#line 1150 "parser.tab.c"
  ...
  case 12: /* members: key COLON value  */
#line 62 "parser.y"
                      { 
          (yyval.obj_val) = new ObjectNode(); 
          (yyval.obj_val)->addMember(std::string((yyvsp[-2].str_val)), (yyvsp[0].node_val)); 
          free((yyvsp[-2].str_val));
      }
#line 1160 "parser.tab.c"
    break;

  case 13: /* members: members COMMA key COLON value  */
#line 67 "parser.y"
                                    { 
          (yyval.obj_val) = (yyvsp[-4].obj_val); 
          (yyval.obj_val)->addMember(std::string((yyvsp[-2].str_val)), (yyvsp[0].node_val)); 
          free((yyvsp[-2].str_val));
      }
...
#line 80 "parser.y"
            { 
          (yyval.arr_val) = new ArrayNode(); 
          (yyval.arr_val)->addElement((yyvsp[0].node_val)); 
      }
